...
// Delete all product from the user cart
...
// To display the item in the cart
         ...
         if (mysqli_num_rows($select_cart) > 0) {
            while ($fetch_cart = mysqli_fetch_assoc($select_cart)) {
               ...
               <div class="box">
                  ...
                  <div class="name">Quant stock:
                     <?php echo $fetch_cart['quantity']; ?>
                  </div>
                  <form action="" method="post">
                     <input type="hidden" name="cart_id" value="<?php echo $fetch_cart['id']; ?>">
                     <input type="hidden" name="item_size" value="<?php echo $fetch_cart['pro_size']; ?>">
                     <input type="number" min="1" name="cart_quantity" value="<?php echo $fetch_cart['quantity']; ?>">
                     <input type="submit" name="update_cart" value="update" class="option-btn">
                  </form>
                  <div class="sub-total"> sub total : <span>RM
      ...
      <div class="cart-total">
         ...
         <?php $final_total_chechout = $grand_total + 5 ?>
      <p>Total Payment: <span>RM <?php echo $final_total_chechout;?>.00</span></P>      
            </span></p>
         <div class="flex">
